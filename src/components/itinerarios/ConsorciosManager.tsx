    ...
    <div className="space-y-4">
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1.5">
                  <div className={`text-xs font-semibold space-y-1 ${theme === 'dark' ? 'text-[#A0A0A0]' : 'text-[#6B6B6B]'}`}>
                    <p>Servicios: <span className={`font-bold ${theme === 'dark' ? 'text-white' : 'text-[#1F1F1F]'}`}>{consorcio.servicios?.length || 0}</span></p>
                    <p>Naves únicas: <span className={`font-bold ${theme === 'dark' ? 'text-white' : 'text-[#1F1F1F]'}`}>{navesUnicas.size}</span></p>
                    <p>Destinos únicos: <span className={`font-bold ${theme === 'dark' ? 'text-white' : 'text-[#1F1F1F]'}`}>{destinosUnicos}</span></p>
                  </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md px-4">
          <div className={`w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl ${theme === 'dark' 
