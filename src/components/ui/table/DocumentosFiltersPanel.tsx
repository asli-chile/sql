  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-80 transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        {/* Header */}
        <div className={`flex items-center justify-between p-4 border-b ${theme === 'dark' ? 'border-slate-800' : 'border-gray-200'}`}>
          ...
          <div>
            ...
            <div className="space-y-2 max-h-32 overflow-y-auto">
              ...
              {filterOptions.clientes.map((cliente) => (
                <label key={cliente} className="flex items-center gap-2 text-sm cursor-pointer">
                  <input
                    type="checkbox"
        ...
        <div className={`p-4 border-t ${theme === 'dark' ? 'border-slate-800' : 'border-gray-200'}`}>
          {hasActiveFilters && (
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${theme === 'dark'
