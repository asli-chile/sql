-- Script definitivo para solucionar el error de ambigüedad (con CASCADE)
-- Ejecutar en el SQL Editor de Supabase

-- 1. ELIMINAR todas las funciones problemáticas CON CASCADE
...
SELECT 'Funciones recreadas exitosamente con CASCADE - Error de ambigüedad solucionado definitivamente' as resultado;
