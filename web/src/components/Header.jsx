...
const Header = () => {
  ...
  return (
    <header className="bg-asli-dark shadow-lg sticky top-0 z-50 relative">
      ...
      <div
        className={`fixed top-20 left-0 right-0 bg-asli-dark border-t border-gray-700 shadow-xl z-40 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col space-y-4">
            ...
            {/* Social Media Icons */}
            <div className="flex items-center space-x-3 mt-6 pt-6 border-t border-gray-700">
              <a
